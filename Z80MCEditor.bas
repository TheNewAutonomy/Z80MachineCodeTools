...
2080 NEXT K
2090 IF K = 5 OR VAL k$ = ze OR VAL k$ > ln THEN GO TO mr
...
2300 IF TP <> BP AND TP <> ln THEN LET TP = TP+on : GO TO 2290
2310 LET TP = on
2320 LET pp = n
2330 IF n < TP THEN LET pp = TP: GO TO 2380
2340 LET numlp = ze
2350 IF pp = TP THEN LET pp = TP : GO TO 2380
...
4040 IF LEN A$ > fr AND n1 > 47 AND n1 < 58 THEN LET p11 = VAL A$(5 TO 8)
4050 GO SUB 1000
4060 GO TO mr
5000 REM
...
5100 IF j1 < ze OR j1 > ln THEN GO TO 5460
...
8030 INPUT "Source or Machine code : (s or m)" ; k$
...
9025 BORDER 7 : PAPER 7 : INK on : INVERSE ze : OVER ze: FLASH ze : BRIGHT ze : BEEP .25, 24 : BEEP .25, 12
